...
const unsigned char myFont[][8] PROGMEM = {
 ...
 //   static void sendStr(unsigned char *string)
    ...
    static void sendStr( char *string)   // Todo: check why compile to AVR raise no error in char* cast
    #endif
...
#ifdef P8544
 static void _splash (void)
{
  #ifdef TZXDuino_Logo
  //lcd.gotoRc(0, 0);
  lcd.setCursor(0, 0);
  //lcd.bitmap(TZXDuino84x48_1, 3,84);
  lcd.drawBitmap(TZXDuino84x48_1, 84,3);

  
  //lcd.gotoRc(3, 0);
  lcd.setCursor(0,3); // column, row
//  lcd.bitmap(TZXDuino84x48_2, 3,84);
  lcd.drawBitmap(TZXDuino84x48_2, 84,3);
...
//  lcd.bitmap(logo1, 3,84);  
  lcd.drawBitmap(logo1, 84,3);

  
//  lcd.gotoRc(3, 0);
  lcd.setCursor(3,0); // column, row
//   lcd.bitmap(logo2, 3,84);  
  lcd.drawBitmap(logo2, 84,3);
  #endif
  delay(1500);
  lcd.clear();
  //delay(1000);
