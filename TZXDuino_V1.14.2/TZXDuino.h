...
#if defined(__AVR__)
#define outputWriteLow()    outputPinPORT&=(~(1<<outputPinBIT))  //LowWrite(x,y) 
#define outputWriteHigh()   outputPinPORT|=(1<<outputPinBIT) //HighWrite(x,y)
#elif defined(__arm__) && defined(__STM32F1__)     
#define outputWriteLow()  digitalWrite(outputPin,LOW)
#define outputWriteHigh() digitalWrite(outputPin,HIGH)
#endif
